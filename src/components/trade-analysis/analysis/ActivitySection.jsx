...
import { Card, Grid, HBar, CardTitle, EmptyHint, DIRECTION_COLOR, STATUS_COLOR } from './primitives'
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          opacity: cell.count === null ? 0 : opacity,
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <div className="flex-1 rounded-xl px-2 py-1.5 text-center" style={{ backgroundColor: 'color-mix(in srgb, var(--ta-surface) 85%, #16a34a 15%)' }}>
                <div className="text-[15px] font-extrabold" style={{ color: DIRECTION_COLOR.Buy }}>{buy}</div>
              ...
              <div className="flex-1 rounded-xl px-2 py-1.5 text-center" style={{ backgroundColor: 'color-mix(in srgb, var(--ta-surface) 85%, #dc2626 15%)' }}>
                <div className="text-[15px] font-extrabold" style={{ color: DIRECTION_COLOR.Sell }}>{sell}</div>
