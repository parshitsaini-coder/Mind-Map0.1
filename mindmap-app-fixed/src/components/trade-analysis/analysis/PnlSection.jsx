...
import { Card, Grid, CardTitle, EmptyHint, Stat } from './primitives'
      ...
      <Card delay={0.05}>
        ...
        {!hasAnyPnl ? (
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <Stat
              label="Avg / Trade"
              value={stats.avgPnl == null ? '—' : fmtMoney(stats.avgPnl)}
            />
            <Stat
              label="Best Trade"
              value={stats.bestTrade ? fmtMoney(stats.bestTrade.pnl) : '—'}
              sub={stats.bestTrade ? (stats.bestTrade.instrumentName || stats.bestTrade.pair) : undefined}
            />
            <Stat
              label="Worst Trade"
              value={stats.worstTrade ? fmtMoney(stats.worstTrade.pnl) : '—'}
